...
type Props = {
  children: ReactNode;
  activeNav?: 'overview' | 'verification' | 'students' | 'drives' | 'filtering' | 'stages' | 'offerFilters' | 'placementResults' | 'analytics' | 'alerts' | 'reports';
...
export default function FacultyLayout({ children, activeNav, onNavigate }: Props) {
  ...
  const navItems = [
    ...
    { key: 'offerFilters', label: 'Offer Filters',        icon: <BarChart3      size={16} />, path: ROUTES.facultyOfferFilters },
